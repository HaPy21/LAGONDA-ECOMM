          ...
          <div class="row d-flex align-items-center">
            <div class="col-sm-7 d-none d-sm-block">
              <ul class="list-inline topbar-text mb-0">
                ...
                <li class="list-inline-item px-3 border-start d-none d-lg-inline-block">Envios gratis desde S/790.00</li>
              </ul>
            </div>
            <div class="col-sm-5 d-flex justify-content-end">
              ...
              <!-- Currency Dropdown-->
              <div class="dropdown ps-3 ms-0"><a class="dropdown-toggle topbar-link" id="currencyDropdown" href="#" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false">Moneda</a>
